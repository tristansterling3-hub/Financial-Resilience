    ...
    [
      {
        ...
        text: rows.map((r) => Number(r.Median_Income).toLocaleString()),
        ...
        marker: { line: { color: "#dbe9ff", width: 0.9 } },
        opacity: 0.9,
        colorbar: {
          title: "Resilience",
          titlefont: { color: "#dce9ff" },
          tickfont: { color: "#dce9ff" },
          bgcolor: "rgba(5,11,24,0.65)",
          bordercolor: "rgba(220,233,255,0.35)",
          borderwidth: 1,
          thickness: 16,
        },
        hovertemplate: "<b>%{location}</b><br>Income: %{text}<br>Score: %{z:.3f}<extra></extra>",
      },
    ],
    {
      mapbox: {
